...
# The name of a Pygments style to use for syntax highlighting:  manni, emacs,
# perldoc, tango, vim, paraiso-light, default, borland, friendly, igor, algol,
# bw, autumn, colorful, algol_nu, fruity, rrt, vs, pastie, paraiso-dark, native,
# xcode, lovelace, trac, monokai, murphy
